...
UIAnimatedSprite::UIAnimatedSprite(std::string firstImage,int FrameMilliseconds)
{
	this->FrameMilliseconds = FrameMilliseconds;
	AddFrame(firstImage);
}
UIAnimatedSprite::UIAnimatedSprite(std::string firstImage,std::string secondImage)
{
	AddFrame(firstImage);
	AddFrame(secondImage);
}
...
void UIAnimatedSprite::AddFrame(std::string Path)
{
